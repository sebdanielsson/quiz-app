...
The Quiz App is a modern, full-stack quiz platform built with Next.js 16. It features OIDC authentication, role-based access control, AI-powered quiz generation, real-time leaderboards, and a comprehensive REST API.

### Is it free to use?

Yes, the Quiz App is open-source and MIT licensed. You can use it for free, modify it, and deploy it anywhere.
