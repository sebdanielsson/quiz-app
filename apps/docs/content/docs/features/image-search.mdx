---
title: Image Search
description: Search and select images from Unsplash
---

# Image Search

Respondeo includes an image picker that allows users to search and select images from web providers when creating quizzes. This feature makes it easy to add high-quality images to quiz questions and hero images.
