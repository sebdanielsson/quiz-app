...
description: Generate quizzes with AI using multiple providers
---

# AI Quiz Generation

Respondeo supports AI-powered quiz generation using the [Vercel AI SDK](https://ai-sdk.dev/). Users with the appropriate permissions can generate complete quizzes from a simple theme or topic description.
