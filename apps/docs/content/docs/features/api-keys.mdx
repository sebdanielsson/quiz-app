...
The Quiz App provides API keys for programmatic access to the REST API. API keys are managed through the web interface and inherit permissions dynamically from the user's role.
...
- [OpenAPI Documentation](https://yourapp.com/docs) — Interactive API docs
